...
//		System.out.println(reverseString2);
		...
		/*
		 * 
		 * Program to be improved by removing the duplicates in String
		 * 
		 */
		
		System.out.println("7. Program to be improved by removing the duplicates in String");
		
		System.out.println("-----");
		
		String strInputtt="Atif";
		
		int vowelCount=0;
		
		int consCount=0;
		
		for(int i=0;i<strInputtt.length();i++)
		{
			if(strInputtt.toLowerCase().charAt(i)=='a'||strInputtt.toLowerCase().charAt(i)=='e'||strInputtt.toLowerCase().charAt(i)=='i'||strInputtt.toLowerCase().charAt(i)=='o'||strInputtt.toLowerCase().charAt(i)=='u')
			{
				vowelCount++;
			}
			else
		...
		String strInpttttt="abcdefghijklmnopqrstuvwxyz";
		...
		for(int i=0;i<strInpttttt.length();i++)
		{
			...
			if(strInpttttt.toLowerCase().charAt(i)>='a' && strInpttttt.toLowerCase().charAt(i)<='z')
			{
				counttttt++;
			}
		}
